...
import "./DaftarDonasiPage.css";

import { GetAllBarangRequest, GetAllBarangByCategory, SearchBarang } from "../../api/apiBarang";
...
const ItemList = ({ barang }) => {
    ...
    const { nama_barang, foto_barang } = barang;
...
const DaftarDonasiPage = () => {
    ...
    return (
        <div className="main-container-organisasi">
