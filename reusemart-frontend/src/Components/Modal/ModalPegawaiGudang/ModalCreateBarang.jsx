...
import { CreateBarang } from "../../../api/apiBarang";
...
const ModalCreateBarang = ({ show, handleClose, onSuccess, id_transaksi_penitipan }) => {
    ...
    const id_transaksi_penitipan2 = id_transaksi_penitipan || null;
    ...
    const [skipKategoriSearch, setSkipKategoriSearch] = useState(false);


    const [pegawaiOptions, setPegawaiOptions] = useState([]);
    const [showPegawai, setShowPegawai] = useState(false);
    const [id_pegawai, setIdPegawai] = useState(null);
    const [skipPegawaiSearch, setSkipPegawaiSearch] = useState(false);
    ...
    const [skipHunterSearch, setSkipHunterSearch] = useState(false);
    ...
    useEffect(() => {
        ...
        const fetchKategoriOptions = async () => {
            if (formData.kategori_barang.length > 2) {

                try {
                    const response = await SearchKategori(formData.kategori_barang);
        ...
        const debounceTimer = setTimeout(fetchKategoriOptions, 300);
    ...
    useEffect(() => {
        ...
        const debounceTimer = setTimeout(fetchPegawaiOptions, 300);
        return () => clearTimeout(debounceTimer);
    ...
    useEffect(() => {
        ...
        const debounceTimer = setTimeout(fetchHunterOptions, 300);
        return () => clearTimeout(debounceTimer);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!formData.nama_barang || !formData.kategori_barang || !formData.harga_barang || !formData.tanggal_garansi || !formData.kondisi_barang || !formData.deskripsi_barang || !formData.berat_barang || !formData.nama_pegawai) {
            ...
            formDataToSend.append('nama_kategori', formData.kategori_barang);
            ...
            formDataToSend.append('id_transaksi_penitipan', id_transaksi_penitipan2);
            ...
            await CreateBarang(formDataToSend);
            onSuccess?.();
            handleClose();
    ...
    const handleKategoriOptions = (kategori) => {
    ...
    const handlePegawaiOptions = (pegawai) => {
    ...
    const handleHunterOptions = (hunter) => {
            ...
            {isLoading ? (
                ...
                <Container className="modal-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <InputColumn
                            nameLabel="kategori_barang"
                            contentLabel="Kategori Barang"
                            typeInput="text"
                            idInput="kategori_barang"
                            placeholderInput="Masukkan Kategori Barang..."
                            ...
                            <div style={{
                                ...
                                {kategoriOptions.map((kategori, index) => (
                                    <div
                                        ...
                                        onClick={() => handleKategoriOptions(kategori)}
                            ...
                            <div style={{
                                ...
                                {pegawaiOptions.map((pegawai, index) => (
                                    <div
                                        ...
                                        onClick={() => handlePegawaiOptions(pegawai)}
                                        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#f5f5f5'}
                                        onMouseLeave={e => e.currentTarget.style.backgroundColor = 'white'}
                                    >
                            ...
                            <div style={{
                                ...
                                {hunterOptions.map((hunter, index) => (
                                    <div
                                        ...
                                        onClick={() => handleHunterOptions(hunter)}
                                        onMouseEnter={e => e.currentTarget.style.backgroundColor = '#f5f5f5'}
                                        onMouseLeave={e => e.currentTarget.style.backgroundColor = 'white'}
                                    >
                                        {hunter.nama_hunter}
